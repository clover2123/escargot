...
void Memory::addGCEventListener(OnGCEventListener l, GCEventType type)
{
    GCEventListenerList& list = ThreadLocal::gcEventListenerList();
    GCEventListenerList::EventListenerVector* listeners = nullptr;
...
bool Memory::removeGCEventListener(OnGCEventListener l, GCEventType type)
{
    GCEventListenerList& list = ThreadLocal::gcEventListenerList();
