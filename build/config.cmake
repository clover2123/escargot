...
IF (ESCARGOT_LIBICU_SUPPORT)
    ...
    ELSE()
        IF (NOT ${ESCARGOT_HOST} STREQUAL "windows")
            ...
            PKG_CHECK_MODULES (ICUDATA REQUIRED icu-data)
        ENDIF()

        SET (ESCARGOT_DEFINITIONS ${ESCARGOT_DEFINITIONS} -DENABLE_ICU -DENABLE_INTL)

        IF (${ESCARGOT_HOST} STREQUAL "darwin")
            FOREACH (ICU_LDFLAG ${ICUI18N_LDFLAGS} ${ICUUC_LDFLAGS} ${ICUDATA_LDFLAGS})
                SET (ESCARGOT_LDFLAGS ${ESCARGOT_LDFLAGS} ${ICU_LDFLAG})
            ENDFOREACH()
        ELSE()
            SET (ESCARGOT_LIBRARIES ${ESCARGOT_LIBRARIES} ${ICUI18N_LIBRARIES} ${ICUUC_LIBRARIES} ${ICUDATA_LDFLAGS})
        ENDIF()
        SET (ESCARGOT_INCDIRS ${ESCARGOT_INCDIRS} ${ICUI18N_INCLUDE_DIRS} ${ICUUC_INCLUDE_DIRS} ${ICUDATA_INCLUDE_DIRS})
        SET (ESCARGOT_CXXFLAGS ${ESCARGOT_CXXFLAGS} ${ICUI18N_CFLAGS_OTHER} ${ICUUC_CFLAGS_OTHER} ${ICUDATA_CFLAGS_OTHER})
    ENDIF()
ENDIF()
