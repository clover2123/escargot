...
IF (ESCARGOT_STACK_ON_HEAP)
    SET (ESCARGOT_DEFINITIONS ${ESCARGOT_DEFINITIONS} -DENABLE_STACK_ON_HEAP)
ENDIF()
...
IF (ESCARGOT_PROFILE)
    SET (ESCARGOT_DEFINITIONS ${ESCARGOT_DEFINITIONS} -DENABLE_PROFILE)
ENDIF()
